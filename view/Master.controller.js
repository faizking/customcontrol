sap.ui.core.mvc.Controller.extend("com.peol.test.view.Master", {
	...
	loadDetailView: function() {
		this.getRouter().myNavToWithoutHash({
			...
			targetViewName: "com.peol.test.view.Detail",
			targetViewType: "XML"
		});
	},
	...
	selectFirstItem: function() {
		...
		if (aItems.length) {
			...
			this.getRouter().myNavToWithoutHash({
				currentView: this.getView(),
				targetViewName: "com.peol.test.view.NotFound",
				targetViewType: "XML"
			});
		}
	},
	...
	onSearch: function() {
		...
		if (searchString && searchString.length > 0) {
			filters = [new sap.ui.model.Filter("AssetDesc", sap.ui.model.FilterOperator.Contains, searchString)];
		}
		// Update list binding
